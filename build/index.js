...
function MiniCart(_ref) {
  ...
  const [showMiniCart, setShowMiniCart] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(woocommerce_grow_cart.display_mini_cart);
  const {
    isLoading,
    error,
    data: cartInformation
...
function Rewards(_ref) {
  ...
  }, reward.name))), rewards.data.rewards.next_rewards.map((reward, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: index
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
