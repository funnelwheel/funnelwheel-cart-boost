...
function RewardsAdminScreen() {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, rewards.data && rewards.data.length ? rewards.data.map(reward => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: reward.id,
    ...
    onClick: () => {
      mutation.mutate({
        security: woocommerce_growcart_rewards.update_rewards_nonce,
        rewards: JSON.stringify(rewards.data.map(reward => {
