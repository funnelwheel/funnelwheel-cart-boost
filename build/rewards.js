...
function Rewards() {
  ...
  const [rewards, setRewards] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(JSON.parse(document.querySelector('input[name="woocommerce_growcart_rewards"]').value));
...
function Styles() {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    for: "field__mini-cart-header-background-color"
  }, "Background Color"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "color",
    ...
    for: "field__mini-cart-header-font-color"
